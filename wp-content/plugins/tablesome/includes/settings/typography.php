...
if (!class_exists('\Tablesome\Includes\Settings\Typography')) {
    class Typography
    {
        public static $webfonts = array();

        public static function get_csf_fonts()
        {
            $webfonts = array();
            ...
            $googlefonts = self::get_google_fonts();

            $webfonts['google'] = array(
                'label' => esc_html__('Google Web Fonts', 'csf'),
                'fonts' => apply_filters('csf_field_typography_googlewebfonts', $googlefonts),
            );
        ...
        public function enqueue($bundle_name)
        {
            // return tablesome_get_google_fonts();

            // if (!wp_script_is('csf-webfontloader')) {

            // CSF::include_plugin_file('fields/typography/google-fonts.php');

            wp_enqueue_script('csf-webfontloader', 'https://cdn.jsdelivr.net/npm/webfontloader@1.6.28/webfontloader.min.js', [], '1.6.28', true);
            ...
            wp_localize_script($bundle_name, 'csf_typography_json', array(
                'webfonts' => $webfonts,
                'defaultstyles' => $defaultstyles,
                'googlestyles' => $googlestyles,
            ));
